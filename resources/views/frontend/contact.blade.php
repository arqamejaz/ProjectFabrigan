...
@section('main-container')
    ...
    <main class="main">
        ...
        <div class="container-fluid page-header text-center">
            <div class="container">
                <h1 class="page-title">{{ $settings->contacth }}<span>{{ $settings->contactsh }}</span></h1>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
        <div class="container-fluid mt-2">
            <div class="page-header page-header-big text-center"
                style="background-image: url('{{ asset('uploads/contactus/' . $contact->contact_page_image) }}');">
            </div><!-- End .page-header -->
        </div><!-- End .container -->
        ...
        <div class="page-content pb-0">
            ...
            <div class="container-fluid">
                <iframe src="{{ $contact->map_link }}" width="100%" height="450" style="border:0;" allowfullscreen=""
