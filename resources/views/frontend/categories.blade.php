    ...
    <main class="main">
        ...
        <div class="swiper mySwiper container-fluid pt-3">
            <div class="swiper-wrapper">
                @foreach (explode(',', $category->sliderImages) as $image)
                    <div class="swiper-slide">
                        <img src="{{ asset('uploads/categories/sliderImages/' . $image) }}" alt="{{ $category->name }}"
                            class="product-image">
                    </div>
                @endforeach
            </div>
                        ...
                        <div class="tab-pane p-0 fade show active" id="featured-women-tab" role="tabpanel"
                            ...
                            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow"
                                ...
                                data-owl-options='{
                                    ...
                                    @foreach (explode(',', $category->serviceImages) as $image)
                                        <div class="product product-7">
                                            <figure class="product-media">
                                                <img src="{{ asset('uploads/categories/serviceImages/' . $image) }}"
