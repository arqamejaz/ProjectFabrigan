                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="inputDescription" name="description" class="form-control" rows="4" required>{{ old('description', $category->description) }}</textarea>
                        </div>
                    </div>
                    <!-- /.card-body -->
                    <div class="card-body">
                        ...
                        <div id="serviceImageUploadFields">
                            <div class="form-group">
                                ...
                                <div id="serviceImagePreview" class="mt-2">
                                    @foreach (explode(',', $category->serviceImages) as $serviceImage)
                                        <img src="{{ asset('uploads/categories/serviceImages/' . $serviceImage) }}" alt="Service Image"
                                            style="width: 100px; height: auto; margin-top: 10px;">
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div id="sliderImageUploadFields">
                            <div class="form-group">
                                ...
                                <div id="sliderImagePreview" class="mt-2">
                                    @foreach (explode(',', $category->sliderImages) as $sliderImage)
                                        <img src="{{ asset('uploads/categories/sliderImages/' . $sliderImage) }}" alt="Slider Image"
                                            style="width: 100px; height: auto; margin-top: 10px;">
                                    @endforeach
                                </div>
                            </div>
